var stui = {
    ...
    mobile: {
        ...
        slide: function () {
            $.getScript("/static/js/flickity.pkgd.min.js", function () {
    ...
    images: {
        lazyload: function () {
            $.getScript("/static/js/jquery.lazyload.js", function () {
                $(".lazyload").lazyload({
                    effect: "fadeIn",
                    threshold: 200,
                    failurelimit: 15,
    ...
    common: {
        ...
        headroom: function () {
            $.getScript("/static/js/headroom.min.js", function () {
                $("#header-top", function () {
